...
**Études au doctorat en biostatistique [En évaluation]  **  
...
- Développement d'analyses prédictives et simulations de scénarios économiques pour la prise de décision stratégique.
...
- **Élaboration des fiches techniques** des produits finis.  
- **Création et mise à jour des données techniques** sur l'ERP (**base articles, gammes, nomenclature, coûts**…).  
- **Gestion des modifications produit** et organisation de leur application dans les lignes de production.  
- **Mise à jour de la base des temps** des opérations de fabrication.  
- **Définition et mise à jour de la base des capacités** des machines et des lignes de production (**quantité et effectif**).  
- **Planification et ordonnancement** de la production.  
- **Reporting du TRS** des machines et de l’efficience des lignes de production.  
- **Suivi du taux de chutes**.  
